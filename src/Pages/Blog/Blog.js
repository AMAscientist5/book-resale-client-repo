    ...
    <div className="w-75 mx-auto">
      ...
      <div>
        ...
        <div>
          <p>
            ...
            easier to reuse. A state is an object that holds information about a
            certain component
          </p>
          <p>
          ...
          <ol>
            <li>
              {" "}
              1.
              <a href="https://www.freecodecamp.org/news/how-to-manage-state-in-your-react-apps/">
                read More
              </a>
            </li>
            <li>
              2.{" "}
              <a href="https://www.freecodecamp.org/news/how-to-manage-state-in-a-react-app/">
                read More
              </a>
            </li>
          </ol>
      ...
      <div>
        ...
        <div>
          <p>
            ...
            inherit features from one another. a prototype is an inbuilt object
            where it associated with the functions by default, which can be
            accessible, and modifiable, and create new variables and methods to
            it and share across all the instances of its constructor function.
            ...
            objects — the prototypes. inheritance solves the problem of data and
            logic duplication. By inheriting, objects can share properties and
            methods without the need of manually setting those properties and
            methods on each object. A prototype is a built-in property of the
            JavaScript object. The prototype is itself an object, so the
          ...
          <ol>
            <li>
              {" "}
              1.
              <a href="https://www.freecodecamp.org/news/prototypes-and-inheritance-in-javascript/#the-prototype-chain">
                read More
              </a>
            </li>
            <li>
      ...
      <div>
        ...
        <div>
          ...
          <p>
            <h6>How unit tests work</h6>A unit test typically comprises of three
            ...
            the test passes. TDD typically results in an explicit and
            predictable code base. Each test case is tested independently in an
            isolated environment, as to ensure a lack of dependencies in the
            code. The software developer should code criteria to verify each
            test case, and a testing framework can be used to report any failed
            tests. Developers should not make a test for every line of code, as
            this may take up too much time. Developers should then create tests
            ...
            evaluated by means of integration testing. Unit tests should be
            performed frequently, and can be done manually or can be automated.
          </p>
          <p>
            ...
            framework to develop test cases. These frameworks are also set to
            flag and report any failed test cases while also providing a summary
            of test cases.
          </p>
          ...
          <ul>
            ...
            <li>
              Unit testing may have a steep learning curve, for example, having
              to learn how to use specific automated software tools.
            </li>
          </ul>
          <ol>
            <li>
              {" "}
              1.
              <a href="https://www.techtarget.com/searchsoftwarequality/definition/unit-testing#:~:text=The%20main%20objective%20of%20unit,find%20in%20later%20testing%20stages.">
                read More
              </a>
            </li>
            <li>
              2.{" "}
              <a href="https://www.guru99.com/unit-testing-guide.html">
                read More
              </a>
            </li>
          </ol>
      ...
      <div>
        ...
        <div>
          ...
          <p>
            After doing a thorough analysis of Angular vs React vs Vue we tried
            to sum up all in the comparison table for you to understand it in a
            better and easy way
          </p>
          ...
          <ol>
            <li>
              {" "}
              1.
              <a href="https://wpwebinfotech.com/blog/angular-vs-react-vs-vue/">
                read More
              </a>
            </li>
            <li>
              2.{" "}
              <a href="https://plainenglish.io/blog/angular-vs-react-vs-vue-js-which-is-the-best-choice-for-2022">
                read More
              </a>
            </li>
          </ol>
